...
export const teste = tv({
  slots: {
    card: "group flex flex-col-reverse mx-3 xl:w-[500px] w-[1500px] xl:h-[750px] h-[2250px] xl:min-w-[500px] xl:min-h-[300px] min-w-[1500px] min-h-[2250px] transition-all duration-180 bg-cover hover:cursor-pointer hover:h-[800px] hover:z-[1000] rounded-2xl bg-no-repeat bg-center",
